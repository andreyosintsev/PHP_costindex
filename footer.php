...
<nav>
	<ul>
		<li>
			<a href="http://costindex.ru" title="На главную страницу">Главная</a>
		</li>
		<li>
			<a href="http://costindex.ru/goods.php" title="К перечню товаров">Товары</a>
		</li>
		
		<?php if (!empty($_SESSION['login']) and !empty($_SESSION['id']) and ($_SESSION['role']=='admin')) {
			echo '
				<li>
					<a href="http://costindex.ru/addvalue.php" title="Добавить новый чек">Добавить чек</a>
				</li>
			';
			 }				
		?>
